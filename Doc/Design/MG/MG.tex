...
which the software is written in. \wss{There really isn't a way to hide this in
...
\item[\refstepcounter{ucnum} \uctheucnum \label{ucOutput}:] The format of the output data.
