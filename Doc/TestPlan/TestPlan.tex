...
\begin{tabular}{|c|p{8cm}|p{6cm}|}
  ...
  02& $f(x, y) = y'' + y' + x + 2$ & error: invalid input\\ \hline
  03& $f(x, y) = y' + 1$ & error: invalid input\\ \hline
  04& $f(x, y) = (dx/dy) + 1$ & error: invalid input\\ \hline
  05& $f(x, y) = (y + 1) / x$ & error: invalid input\\ \hline
  06& $f(x, y) = y^2 + x$ & error: invalid input\\ \hline
  07& Boundary Value Problem & error: invalid input\\ \hline
  08& $h = -1$ & error: invalid input\\ \hline
  09& $h = 0$ & error: invalid input\\ \hline
  10& $x_0 = i$ & error: invalid input\\ \hline 
  11& $x_0 = [0, 1]$ & error: invalid input\\ \hline 
  12& $y_0 = i$ & error: invalid input\\ \hline 
  13& $y_0 = [0, 1]$ & error: invalid input\\ \hline
  14& $x_k = i$ & error: invalid input\\ \hline 
  15& $x_k = [0, 1]$ & error: invalid input\\ \hline
...
Type: Functional, Manual, System %Functional, Dynamic, Manual, Static etc.
					
Initial State: Not applicable
					
Input: $f(x, y) = y, h = 0.5, x_0 = 0, y_0 = 1, x_k = 0.5$
